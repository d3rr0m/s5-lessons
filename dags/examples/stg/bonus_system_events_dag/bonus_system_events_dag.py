...
@dag(
    ...
    tags=['sprint5', 'stg', 'origin', 'mine'],  # Теги, используются для фильтрации в интерфейсе Airflow.
    is_paused_upon_creation=True  # Остановлен/запущен при появлении. Сразу запущен.
)
def spri3nt5_stg_bonus_system_events_dag():
...
stg_bonus_system_events_dag = spri3nt5_stg_bonus_system_events_dag()
